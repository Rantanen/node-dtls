...
ServerHandshakeHandler.prototype.handle_clientKeyExchange = function( handshake ) {
    ...
    this.newParameters.preMasterKey = preMasterSecret;
    this.newParameters.masterKey = prf( this.version )(
        preMasterSecret,
        "master secret", 
        Buffer.concat([
            this.newParameters.clientRandom,
            this.newParameters.serverRandom ]), 48 );
